    ...
    <!-- <div class="smid-content">
      ...
      <el-dialog title="0" :visible.sync="dialogVisible" width="30%" >
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="dialogVisible = false">3</el-button>
          <el-button type="primary" @click="dialogVisible = false">4</el-button>
        </span>
      </el-dialog>
      <h1>存储信息</h1>
      ...
      <div class="smid-content-2">
        ...
        <el-button type="text" style="position: absolute;top:100px;left:150px" @click="dialogVisible = true">升级云空间
        </el-button>
      </div>
    </div> -->
